        ...
        <div class="col-md-6">
                ...
                <form method="POST" action="${contextPath}/login" class="box">
                    ...
                    <div class="form-group ${status.error ? 'has-error' : ''}">
	                    <input type="text" name="email" placeholder="<spring:message code='form.email' />" required> 
	                    <input type="password" name="password" placeholder="<spring:message code='form.password' />" required>  
